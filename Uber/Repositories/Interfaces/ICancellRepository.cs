...
namespace Uber.Repositories.Interfaces
{
    public interface ICancellRepository
    {
        ...
        public Task<Cancellation?> GetCancellationByIdAsync(Guid canelletionId);
        ...
        public Task<Cancellation?> getCancelletionByDriverIAndTripID(string driverId, Guid tripId);
    }
}
